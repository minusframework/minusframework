...
Todas as funÃ§Ãµes retornam `0` para sucesso ou cÃ³digo de erro:

| CÃ³digo | Constante | DescriÃ§Ã£o |
|--------|-----------|-----------|
| `0` | `ORM_OK` | Sucesso |
| `-1` | `ORM_ERRO_CONEXAO` | Falha de conexÃ£o |
| `-2` | `ORM_ERRO_EXECUCAO` | Erro na execuÃ§Ã£o SQL |
| `-3` | `ORM_ERRO_PARAMETRO` | ParÃ¢metro invÃ¡lido |
| `-4` | `ORM_NAO_CONECTADO` | NÃ£o conectado |

Ãšltimo erro: `const char* ORM_GetLastError();`
