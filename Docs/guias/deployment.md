...
Os `.bpl` são gerados em `C:\Users\Public\Documents\Embarcadero\Studio\23.0\Bpl\`
...
### Aplicação standalone (static link)

Para evitar dependência de `.bpl`, compile os projetos `.dpr` diretamente:
